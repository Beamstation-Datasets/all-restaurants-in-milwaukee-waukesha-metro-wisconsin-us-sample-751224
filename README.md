# All Restaurants in Milwaukee-Waukesha (Metro), Wisconsin, US

> Free BeamStation sample export with 326 rows and masked direct-contact fields.
...
| Full dataset size | 3,260 records |
| Free sample size | 326 records (10.0%) |
| Last export | 2026-04-09T13:52:10.155843+00:00 |
| Download | [Latest release asset](https://github.com/Beamstation-Datasets/all-restaurants-in-milwaukee-waukesha-metro-wisconsin-us-sample-751224/releases/download/sample-latest/beamstation_751224_restaurants-us-milwaukeewaukeshawi_SAMPLE_DIST.csv) |
...
Search for dataset ID `751224` on BeamStation if you want the exact commercial listing.
